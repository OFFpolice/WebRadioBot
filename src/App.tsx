  ...
  return (
    <div className="flex justify-center w-full min-h-screen bg-[#0e0e0e] text-white font-sans antialiased">
      ...
      >
        ...
        >
          <h1 className="text-2xl font-bold bg-gradient-to-r from-[#c2185b] to-[#e91e63] bg-clip-text text-transparent inline-block pt-1.2 mb-1 tracking-[-0.5px] select-none">
            WebRadioBot
          </h1>
